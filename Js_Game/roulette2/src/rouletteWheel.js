...
function getColor(index, total) {
    ...
    //     b = hue2rgb(p, q, h - 1 / 3);
    // }
    var wheel = [00,27,10,25,29,12,8,19,31,18,6,21,33,16,4,23,35,14,2,0,28,9,26,30,11,7,20,32,17,5,22,34,15,3,24,36,13,1]
    var num = wheel[index]
    var red = [1, 3, 5, 7, 9, 12, 14, 16, 18, 19, 21, 23, 25, 27, 30, 32, 34, 36]
    var black = [2,4,6,8,10,11,13,15,17,20,22,24,26,28,29,31,33,35]
    if( red.indexOf(num) >= 0) { return [255, 0, 0] } else
    if( black.indexOf(num) >= 0 ) { return [0, 0, 0 ] }
    else { return [0, 255, 0 ]}
